...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'todolist.com'
  config.app_name = 'Todolist'
  config.mailer.from = 'Todolist <no-reply@todolist.com>'
  ...
  #
  config.app_secret = 'LBBQLw_3a13BMxrs21hVCGSkTJtvTiVl-M9M9V1PRUqfNkOE6lpOmrFwwChZr8d-XVI'
